...
public class HikerHierarchy : EditorWindow
{
    private static HikerHierarchy window;
    ...
    [MenuItem("HikerHierarchy/Open Hierarchy")]
    private static void Init()
    {
        mCurrentScene = SceneManager.GetActiveScene();
        window = (HikerHierarchy)GetWindow(typeof(HikerHierarchy), false, "Hiker Hierarchy");
        window.Show();
