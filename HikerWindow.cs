...
public class HikerWindow : EditorWindow
{
    private static HikerWindow window;
    Vector2 scrollPos;
    private static List<Object> m_ListFolder = new List<Object>();

    [MenuItem("HikerHierarchy/Open Project Window")]
    private static void Init()
    {
        window = (HikerWindow)EditorWindow.GetWindow(typeof(HikerWindow), false, "Hiker Window");
        window.Show();
    ...
    static string saveKey { get { return "H2W " + Application.dataPath; } }
    static void save()
    {
    ...
    public void OnGUI()
    {
        ...
        foreach (Object o in m_ListFolder)
        {
            ...
            else
            {
                ...
                GUI.backgroundColor = Selection.GetFiltered(typeof(UnityEngine.Object), SelectionMode.Assets).Contains(o) ? Color.green : oldColor;
